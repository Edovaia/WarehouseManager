...
if(!isset($_SESSION["dipendente"])){
 ...
 <!DOCTYPE html>
  ...
  <div class="container-fluid">
    <a class="nav-link" style="margin-left:-10px;" href="dipendente_home.php"><nobr><b>Scuderia Torino</b></nobr></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link logout" href="logout_dipendente.phpp">Logout</a>
        </li>
      </ul>
  ...
  <body background="immagini\DSC_0474_PS_2_senza-scritta.jpg">
   <div id="div_principale_cerca_magazzino_dip">
  <?php
  $conn=mysqli_connect("localhost","root","","scuderia torino");
  $x="SELECT * FROM magazzino WHERE nome_prodotto='$_POST[cerca]' || azienda_produttrice='$_POST[cerca]'";
  $q=mysqli_query($conn,$x);
  if(mysqli_num_rows($q)>0){
     ?>
     <table class="table" id="table_cerca_magazzino_dip">
     ...
     while($row=mysqli_fetch_assoc($q)){
        ?>
        <tr><?php
            echo "<td><a role='button' id='cerca_magazzino_dip_link' title='clicca qui per vedere la scheda tecnica' href='scheda_tecnica_dip.php?id_prodotto=$row[id_prodotto]'> $row[nome_prodotto] </a></td>"; ?>
    ...
    ?>
    <center>
    <div id="cerca_magazzino_dip">
      <?php
    echo "<p id='p_cerca_magazzino_dip'>I prodotti selezionati non sono presenti nel magazzino.</p>";
    ?>
    </div>
  </center>
      <?php
