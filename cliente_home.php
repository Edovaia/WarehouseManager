  ...
  <a class="nav-item" href="cliente_home.php"><nobr><b>Scuderia Torino</b></nobr></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
        <a class="nav-link active" aria-current="page" id="home_dip" href="lavori_cliente.php"><nobr>Lavori</nobr></a>
        </li>
        ...
        <li class="nav-item">
        <a class="nav-link" href="servizio_clienti.php"><nobr>Servizio clienti</nobr></a>
        </li>
        <li class="nav-item">
